...
class SuppressionsApi(object):
    ...
    def create(self, reason, regions, external_account_ids, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(reason, regions, external_account_ids, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_with_http_info(reason, regions, external_account_ids, **kwargs)
        else:
            (data) = self.create_with_http_info(reason, regions, external_account_ids, **kwargs)
            return data

    def create_with_http_info(self, reason, regions, external_account_ids, **kwargs):
        """
        Create a suppression
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(reason, regions, external_account_ids, callback=callback_function)
        ...
        all_params = ['reason', 'regions', 'external_account_ids', 'resource', 'signature_ids', 'custom_signature_ids', 'include']
