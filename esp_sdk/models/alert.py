...
class Alert(BaseObject):
    ...
    def __init__(self, id=None, created_at=None, status=None, risk_level=None, resource=None, ended_reason=None, replaced_by_id=None, replaced_by_status=None, updated_at=None, started_at=None, ended_at=None, external_account=None, external_account_id=None, region=None, region_id=None, signature=None, signature_id=None, custom_signature=None, custom_signature_id=None, suppression=None, suppression_id=None, metadata=None, metadata_id=None, attribution=None, attribution_id=None, tags=None, tag_ids=None, compliance_controls=None, compliance_control_ids=None, custom_compliance_controls=None, custom_compliance_control_ids=None):
        ...
        self._attribution_id = attribution_id
        self._tags = tags
    ...
    def attribution_id(self):
        """
        Gets the attribution_id of this Alert.
        Associated Attribution ID

        :return: The attribution_id of this Alert.
        :rtype: int
        """
        return self._attribution_id

    @attribution_id.setter
    def attribution_id(self, attribution_id):
        """
        Sets the attribution_id of this Alert.
        Associated Attribution ID

        :param attribution_id: The attribution_id of this Alert.
        :type: int
        """
