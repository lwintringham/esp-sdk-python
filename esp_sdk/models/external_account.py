...
class ExternalAccount(BaseObject):
    ...
    """
    def __init__(self, id=None, created_at=None, name=None, updated_at=None, provider=None, team=None, team_id=None, scan_intervals=None, scan_interval_ids=None, disabled_signatures=None, disabled_signature_ids=None, suppressions=None, suppression_ids=None, azure_group=None, azure_group_id=None, credentials=None, credentials_id=None):
        """
