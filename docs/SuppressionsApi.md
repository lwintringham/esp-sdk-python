...
# **create**
> Suppression create(reason, regions, external_account_ids, resource=resource, signature_ids=signature_ids, custom_signature_ids=custom_signature_ids, include=include)
...
try: 
    # Create a suppression
    api_response = api_instance.create(reason, regions, external_account_ids, resource=resource, signature_ids=signature_ids, custom_signature_ids=custom_signature_ids, include=include)
    pprint(api_response)
